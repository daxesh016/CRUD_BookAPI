...
using CRUD_BookAPI.Models;

namespace CRUD_BookAPI.Controllers
{
    ...
    public class BookItemsController : ControllerBase
    {
        ...
        public BookItemsController(BookContext context)
        {
            ...
            if (!_context.BookItems.Any())
            {
                ...
                { Title = "My Truth", Description = "This book offers an overview of the intricacies and problems of being a leader of a country ", Auther = "Ashis Ray", Price = 100 });

                _context.BookItems.Add(new BookItem
                { Title = "My Journey", Description = "From a small boy growing up, to becoming the country's eleventh President", Auther = "Dr. A.P.J. Abdul Kalam", Price = 120 });
